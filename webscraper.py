...
def save_to_csv(books, filename='web.csv'):
    """
...
def scrape_books(url, pages=1):
    ...
    for page in range(1, pages + 1):
        page_url = f"{url}catalogue/page-{page}.html"  # Adjust the URL format based on pagination structure
...
if __name__ == "__main__":
    ...
    # Number of pages to scrape (if pagination is needed)
    num_pages = 5  # Adjust based on the number of pages available
